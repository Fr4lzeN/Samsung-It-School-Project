...
public class FillDataModel {
    ...
    public void createHobbyAdapter(MutableLiveData<HobbyAdapter> hobbiesAdapter, MutableLiveData<Boolean> chipChecked) {
        ...
        FirebaseActions.getHobbyList().addOnCompleteListener(task -> {
            ...
            hobbiesAdapter.setValue(new HobbyAdapter(hobby, checked, chipChecked::setValue));
        });
